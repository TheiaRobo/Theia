...
void fill_line(int startx, int starty, int axis,int n,int val){
	...
	case 1:
		...
		if(val == black){
			...
			for(int x = startx + n + 1; x < x_matrix && (Occupancy_Grid[x+starty*y_matrix] == gray || Occupancy_Grid[x+starty*y_matrix] == blue); x++){

				Occupancy_Grid[x+starty*y_matrix] = blue;
			}
	...
	case 2:
		...
		if(val == black){
			...
			for(int y = starty + n + 1; y < y_matrix && (Occupancy_Grid[startx+y*y_matrix] == gray || Occupancy_Grid[startx+y*y_matrix] == blue); y++){

				Occupancy_Grid[startx+y*y_matrix] = blue;
			}
	...
	case -1:
		...
		if(val == black){
			...
			for(int x = startx - n - 1; x >= 0 && (Occupancy_Grid[x+starty*y_matrix] == gray || Occupancy_Grid[x+starty*y_matrix] == blue); x--){
	...
	case -2:
		...
		if(val == black){
			...
			for(int y = starty - n - 1; y > 0 && (Occupancy_Grid[startx+y*y_matrix] == gray || Occupancy_Grid[startx+y*y_matrix] == blue); y--){
