#ifndef _ROS_differential_drive_Abs_Encoders_h
#define _ROS_differential_drive_Abs_Encoders_h
...
namespace differential_drive
{
  ...
  class Abs_Encoders : public ros::Msg
  {
    public:
      int32_t encoder1;
      int32_t encoder2;
    ...
    const char * getType(){ return "differential_drive/Abs_Encoders"; };
    const char * getMD5(){ return "d0574dbde2411ca40b2b8a4504ddecf9"; };
