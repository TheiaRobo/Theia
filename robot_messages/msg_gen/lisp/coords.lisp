...
(cl:defmethod cl:initialize-instance :after ((m <coords>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'coords)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_messages-msg:<coords> is deprecated: use robot_messages-msg:coords instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <coords>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_messages-msg:header-val is deprecated.  Use robot_messages-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <coords>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_messages-msg:x-val is deprecated.  Use robot_messages-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <coords>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_messages-msg:y-val is deprecated.  Use robot_messages-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <coords>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_messages-msg:z-val is deprecated.  Use robot_messages-msg:z instead.")
  (z m))
