...
class Candidate(genpy.Message):
  _md5sum = "f263ed6f7e1afd54704d02af4c7f32a6"
  _type = "vision_plane/Candidate"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# Object candidate message
float32 dist
float32 minLatitude
float32 maxLatitude
...
"""
  __slots__ = ['dist','minLatitude','maxLatitude','minLongitude','maxLongitude']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       dist,minLatitude,maxLatitude,minLongitude,maxLongitude
