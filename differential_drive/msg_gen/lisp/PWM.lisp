...
(cl:defmethod cl:initialize-instance :after ((m <PWM>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PWM)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name differential_drive-msg:<PWM> is deprecated: use differential_drive-msg:PWM instead.")))
...
(cl:defmethod PWM1-val ((m <PWM>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader differential_drive-msg:PWM1-val is deprecated.  Use differential_drive-msg:PWM1 instead.")
  (PWM1 m))

(cl:ensure-generic-function 'PWM2-val :lambda-list '(m))
(cl:defmethod PWM2-val ((m <PWM>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader differential_drive-msg:PWM2-val is deprecated.  Use differential_drive-msg:PWM2 instead.")
  (PWM2 m))
